...
CREATE TABLE public.gacha_results (
  id UUID NOT NULL DEFAULT gen_random_uuid() PRIMARY KEY,
  user_id UUID NOT NULL REFERENCES auth.users(id) ON DELETE CASCADE,
  template_id UUID NOT NULL REFERENCES public.gacha_templates(id) ON DELETE CASCADE,
...
INSERT INTO public.gacha_templates (id, user_id, name, theme, tier1_count, tier2_count, tier3_count, tier4_count, tier5_count, is_public)
VALUES 
  ('00000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000000', '기본 뽑기', 'classic', 1, 3, 16, 80, 200, true),
  ('00000000-0000-0000-0000-000000000002', '00000000-0000-0000-0000-000000000000', '프리미엄 뽑기', 'golden', 2, 5, 20, 73, 200, true),
  ('00000000-0000-0000-0000-000000000003', '00000000-0000-0000-0000-000000000000', '판타지 뽑기', 'magical', 1, 4, 15, 80, 200, true),
  ('00000000-0000-0000-0000-000000000004', '00000000-0000-0000-0000-000000000000', '사이버 뽑기', 'neon', 1, 2, 17, 80, 200, true),
  ('00000000-0000-0000-0000-000000000005', '00000000-0000-0000-0000-000000000000', '레트로 뽑기', 'vintage', 1, 3, 16, 70, 210, true),
  ('00000000-0000-0000-0000-000000000006', '00000000-0000-0000-0000-000000000000', '우주 뽑기', 'cosmic', 1, 4, 18, 77, 200, true);